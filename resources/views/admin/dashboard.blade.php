...
<head>
    ...
    <title>Admin Dashboard - BlogYaari</title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card stat-card bg-success text-white">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h4 class="mb-0">{{ App\Models\Blog::distinct()->count('category') }}</h4>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p class="text-muted">No blogs found. <a href="{{ route('admin.blogs.create') }}">Create your first blog</a></p>
                        @endif
                    </div>
                </div>
            </main>
